...
export class HSequence extends HBlock {
    ...
    constructor(parent: HBlock|null, condition: string|null = null, startLabel: string|null = null, endLabel: string|null = null) {
        super(parent);
    ...
    init(canvas: HCanvas): void {
        this.x = 0;
        this.y = 0;
        this.startNode = new HSeqStart(this, canvas, this.condition, this.startLabel);
        this.startNode.x = this.x;
        this.startNode.y = this.y;

        this.endNode = new HSeqEnd(this, canvas, null, this.endLabel);
